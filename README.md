...
Bridges Jira issues to [Crew Studio](https://github.com/varkrish/opl-ai-software-team) so that moving an issue to a trigger status (e.g. **Ready for Dev**) automatically creates a build, refactor, or migration job and syncs status back to Jira.
